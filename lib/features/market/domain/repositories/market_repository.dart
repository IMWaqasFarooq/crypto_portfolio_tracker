...
abstract class MarketRepository {
  ...
  Future<Either<Failure, List<Candle>>> getCandles(String coinId, {required int days});

  /// Broadcast stream of live price ticks; union of every active subscriber's symbols.
